...
int main()
{
    ...
    m3d::vec3d object = { 5.0, 3.0, -2.0 * lens.getFocus() };
    ...
    auto recalc = [&]() {
        ...
        window.draw(sprite);
        window.display();
        std::cout << "Rays calculated: " << rayCount << "\n";
