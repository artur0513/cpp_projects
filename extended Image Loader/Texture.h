...
// ƒумаю нужно больше тестов, но в целом вроде работает
class Texture {
private:
...
public:
    GLuint loadFromFile(std::string filename); // ¬озвращает id текстуры в случае успеха, либо 0 в случае ошибки
